	...
	if (ownCards.pattern > otherCards.pattern){
		...
		if (ownCards.pattern === 1){
			if (ownCardsValue[2] != otherCardsValue[2]){
				return (ownCardsValue[2]>otherCardsValue[2]) ? consts.XXConstant.WIN: consts.XXConstant.LOSE;
			}
			else if (ownCardsValue[1] != otherCardsValue[1]){
				return (ownCardsValue[1]>otherCardsValue[1]) ? consts.XXConstant.WIN: consts.XXConstant.LOSE;
			}
			else if (ownCardsValue[0] != otherCardsValue[0]){
				return (ownCardsValue[0]>otherCardsValue[0]) ? consts.XXConstant.WIN: consts.XXConstant.LOSE;
			}
			else {
				return initiative ? consts.XXConstant.WIN: consts.XXConstant.LOSE;
			}
		}
			...
			if (ownDuiziValue === otherDuiziValue){
				...
				if (ownDanValue === otherDanValue){
					...
					return (ownDanValue > otherDanValue) ? consts.XXConstant.WIN: consts.XXConstant.LOSE;
				}
			}
			else {
				return (ownDuiziValue > otherDuiziValue) ? consts.XXConstant.WIN : consts.XXConstant.LOSE;
			}
		}
